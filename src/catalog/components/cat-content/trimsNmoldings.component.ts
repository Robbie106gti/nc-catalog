...
<div class="col s12 m6">
  ...
  <div class="card-panel grey lighten-3 bullet">
    ...
    <ul class="collection">
      <li class="collection-item" *ngFor="let standard of content.standards">{{standard.title}}: {{standard.content}}</li>
    </ul>
    <span class="card-title">
      <h4>Options</h4>
    </span>
    <div class="divider"></div>
    <ul class="collection">
      <li class="collection-item" *ngFor="let option of content.options">{{option.title}}: {{option.content}} <a href="#!" class="secondary-content waves-effect waves-light btn">{{option.option | titlecase}}</a></li>
    </ul>
    <span class="card-title">
      <h4>Restrictions</h4>
    </span>
